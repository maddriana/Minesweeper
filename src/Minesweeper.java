...
public class Minesweeper {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Created by: Adriana Raykova");
    ...
    public void play(){
        ...
        while(i<size*size-mines){
            ...
            switch(check){
                case -1:
                    System.out.println();
                    System.out.println("\u001B[41m" + "Invalid input" + "\u001B[0m");
                    break;
                case 0:
                    i++;
                    break;
    ...
    private void enterCoordinates(){
        ...
        while(x==-1 || y==-1) {
            try {
                ...
                System.out.println("\u001B[41m" + "Please enter a number"+"\u001B[0m");
                scan.next();
                continue;
            }
            ...
            try{
                ...
                y=-1;
                System.out.println();
                System.out.println("\u001B[41m" + "Invalid input - you are outside the playing field"+"\u001B[0m");
            }
        }
    }
